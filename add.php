<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        {
            $not_updated = true;
            $showError = "Sorry:book already exists"; 
        }
        else
        {
           $insert = "INSERT INTO `books` (`bookname`, `pages`) VALUES ('$bookname', '$pages') ";
           $insert_execute = mysqli_query($conn,$insert);
           $updated = true;
...
<html lang="en">
  ...
  <body>
    <!-- <h1 class = "text-center">Add Books Of Your Choice</h1> -->
  ...
  <div class="container-fluid">
    ...
    <div class="d-flex">
        <div class="nav-item">              
         <a class="nav-link text-light active" href="#">Add Books</a>
        </div>
       ...
       <main class="form-signin text-center">
         <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])?>">
           ...
           <div class="form-floating mt-3">
             <input type="text" class="form-control" id="pages" name="pages" placeholder="Book ID" required>
             <label for="pages">Book Pages</label>
           </div>
                
           <button class="w-100 btn btn-lg btn-primary mt-2" type="submit">Add</button>
